...
const PokemonList = () => {
      ...
      const res=pokemonData.map((pokeData)=>{
        console.log(pokeData)
         ...
         return {
                   ...
                   image: (pokeData.data.sprites.other)?pokeData.data.sprites.other.dream_world.front_default : pokeData.data.sprites.front_shiney,
  ...
  return (
    <div className='pokemon-list-wrapper'>
        {/* <div style={{color:"black"}}>List of Pokemon</div> */}
        {isLoading?"Loading...":
